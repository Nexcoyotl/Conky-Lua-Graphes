...
function network_interface()
	return conky_parse('${if_existing /sys/class/net enp0s25}enp0s25${else}${if_existing /sys/class/net wlo1}wlo1${endif}${endif}')
end
...
function disk_watch()
    ...
    disk=tonumber(conky_parse("${fs_used_perc /boot/efi}"))
    if disk<warn_disk then
